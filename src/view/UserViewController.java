...
public class UserViewController implements Initializable {
	...
	@FXML	private TableColumn<Member, String> columnCountry;
	...
	private TableColumn<Member, String> columnArea;
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		//columnArea.setCellValueFactory(cvf -> cvf.getValue().areaProperty());
	...
	/*private String areaNum() {
		if(tfAddress.getText() == "서울북부") {
			return "02";
		}
		else if(tfAddress.getText() == "서울남부") {
			return "02";
		}
		else if(tfAddress.getText() == "경기북부") {
			return "03";
		}
		else if(tfAddress.getText() == "경기남부") {
			return "03";
		}
		else if(tfAddress.getText() == "인천") {
			return "04";
		}
		else if(tfAddress.getText() == "그외지역") {
			return "07";
		}
		else return null; // 이상함
	}*/
	@FXML 
	...
	private void handleCreate() { // event source, listener, handler
		...
		Member newMember = new Member(tfEmail.getText(), tfPw.getText(), tfName.getText(), 
				tfBirth.getText(), ageMake(), tfAddress.getText(), tfContact.getText(), gender());
