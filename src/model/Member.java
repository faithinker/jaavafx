...
public class Member { // DB의 레코드와 매핑되는 객체
	...
	//private StringProperty areaNum;
	...
	*/
	...
	public Member(String email, String pw, String name, String birth,
			String age, String address, String contact, String gender/*, String areaNum*/) {
		...
		/*this.areaNum = new SimpleStringProperty(areaNum);*/
	}
    ...
    /*public String getareaNum() {
		return this.areaNum.get();
	}	
	public void setareaNum(String area) {
		this.areaNum.set(area);
	}
